<x-guest-layout>
    <div class="relative" x-data="{ role: '' }">
        <a href="{{ route('register.student') }}" type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-l-lg text-sm px-5 py-2.5 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Student</a>

        <a href="#" type="button"
            class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-r-lg text-sm px-5 py-2.5 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Lecturer</a>
        ...
        <form method="POST" action="{{ route('register.lecturer.submit') }}" enctype="multipart/form-data">
            @csrf
            @method('post')

            <input type="hidden" id="type" name="type" value="App\Models\Lecturer">
