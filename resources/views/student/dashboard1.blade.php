        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('storage/img/' . $Auth::user()->profilePicture) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ Auth::user()->name->name }} " name="name" required
                                                placeholder="Name">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
...
@endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"
                                                value="{{ $Auth::user()->dateOfBirth }}" name="dateOfBirth" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Profile Pic</label>
                                            <img src="{{ asset('storage/img/' . $Auth::user()->profilePicture) }}"
                                                alt="" style="width: 100px;display: block; margin: 0 auto;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                value="{{ $Auth::user()->score }}" name="score" required
